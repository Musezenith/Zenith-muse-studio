...
const migrations = [
  {
    ...
    upFile: path.join(migrationsDir, "004_create_audit_logs.up.sql"),
    downFile: path.join(migrationsDir, "004_create_audit_logs.down.sql"),
  },
];
...
export async function migrateAuditLogs({ dbPath } = {}) {
