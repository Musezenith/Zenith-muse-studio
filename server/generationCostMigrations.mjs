...
const migrations = [
  {
    name: "006_create_generation_cost_runs",
    upFile: path.join(migrationsDir, "006_create_generation_cost_runs.up.sql"),
    downFile: path.join(migrationsDir, "006_create_generation_cost_runs.down.sql"),
  },
];
...
export async function migrateGenerationCosts({ dbPath } = {}) {
